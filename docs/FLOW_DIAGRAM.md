...
backend/
│
├─ .env                          ❌ NOT in Git (auto-generated)
├─ .env.local                    ✅ IN Git (safe localhost config)
├─ .env.production               ❌ NOT in Git (real secrets!)
├─ .env.production.example       ✅ IN Git (template)
│
├─ run-local.ps1                 ✅ IN Git (automation script)
├─ run-production.ps1            ✅ IN Git (automation script)
│
├─ GETTING_STARTED.md            ✅ IN Git (team onboarding)
├─ docs/
│   └─ SUPABASE_LOCAL_DEV_GUIDE.md  ✅ IN Git (detailed guide)
│
└─ supabase/
    ├─ config.toml               ✅ IN Git (Supabase config)
    ├─ seed.sql                  ✅ IN Git (test data)
...
│  │  (Gets overwritten when switching) │                   │
│  └────────────────┬───────────────────┘                   │
│                   │                                        │
│                   ▼                                        │
│  ┌────────────────────────────────────┐                   │
...
└───────────────────┼────────────────────────────────────────┘
        ...
        ▼                        ▼
┌──────────────────┐    ┌──────────────────┐
│  LOCAL SUPABASE  │    │ PRODUCTION CLOUD │
│                  │    │                  │
│  Docker Desktop  │    │  Supabase.co     │
│  localhost:54321 │    │  https://xxx...  │
│                  │    │                  │
│  Test Data       │    │  Real Data       │
