...
- Backend deploys automatically to Render.com when you push to `staging` branch
- Deploy admin panel to Vercel (connects to staging backend)
- Deploy salon app to Vercel (connects to staging backend)
- Update environment variables with deployed URLs
- Test everything!
...
**Note:** Free tier includes 100 emails/day, perfect for staging!
