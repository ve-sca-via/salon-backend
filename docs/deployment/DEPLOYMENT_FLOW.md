...
│              │      │              │      │              │
│ dev/feature  │─────>│staging branch│─────>│ main branch  │
│   branches   │      │              │      │              │
└──────────────┘      └──────────────┘      └──────────────┘
      │                     │                      │
      │                     │                      │
...
│  Supabase    │      │ salon-backend│      │ salon-backend│
...
- Emails: Real (Resend - customer-facing)
- Payments: Live mode (rzp_live_*)
- Platform: Render.com (Singapore region)
- URL: Auto-generated by Render
- Branch: `main`
- Local Test: `.\run-production.ps1`
