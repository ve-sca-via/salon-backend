...
| Environment | Purpose | Database | Email | Payments | Branch |
|------------|---------|----------|-------|----------|--------|
| **Development** | Local coding | Local Docker | Disabled/Mailpit | Test mode | `dev` |
| **Staging** | Online testing | Staging Supabase | Real emails | Test mode | `staging` |
| **Production** | Live system | Production Supabase | Real emails | Live mode | `main` |
